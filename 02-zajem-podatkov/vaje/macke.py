...
def download_url_to_string(url):
    ...
    try:
        ...
        return None
    # Status codes nam pove, kakšen je bil dogovor
...
def page_to_ads(page_content):
    ...
    vrne njih seznam"""
    # Pika se ujema z vsem
    pattern = re.compile('<li class="EntityList-item EntityList-item--Regular(.*?)</article>', re.DOTALL)
    
    return re.findall(pattern, page_content) # ce ne bi prej dal .dotall bi mu lahko tu dodali flage 
...
def get_dict_from_ad_block(block):
    ...
    #Lahko bi uporabil compile, ampak smo dodali pri re.ime_metode
